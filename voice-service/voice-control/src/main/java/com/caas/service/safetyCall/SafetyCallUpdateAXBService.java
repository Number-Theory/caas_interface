 ...
 */
@Service
public class SafetyCallUpdateAXBService extends DefaultServiceCallBack {
	private static final Logger logger = LogManager.getLogger(SafetyCallUpdateAXBService.class);
	...
	public void callService(ChannelHandlerContext ctx, ServiceRequest request, ServiceResponse response, Map<String, Object> paramsObject) {
		...
		logger.info("【请求广西东信绑定更新接口路径】返回结果resp={}", respData);
